...
DEPS_STATIC_LIBS := deps/libkc/logger/libkc_logger.a
...
build: $(EXTRACT_DEPS) $(OBJECTS) libkc_system.a
...
libkc_system.a: $(OBJECTS) $(EXTRACT_DEPS) | $(LIB_OUT_DIR)
	ar rcs $(LIB_OUT_DIR)/libkc_system.a $(OBJECTS) $(shell find $(TMP_OBJ_DIR) -type f -name '*.o')
...
TEST_STATIC_LIBS := kc_system kc_testing
